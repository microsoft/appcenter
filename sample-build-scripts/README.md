...
**WARNING** - Build scripts allow you to add custom functionality beyond the normal scope of product support. Build script samples are provided as-is, and may be sufficient for your use case; but you might also encounter limitations that aren't directly addressable by App Center support.
